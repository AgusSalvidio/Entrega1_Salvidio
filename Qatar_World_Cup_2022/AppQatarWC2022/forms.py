...
from django.contrib.auth.models import User    #si lo agrego no me muestra los users en la view de users... revisar de cambiar el nombre
...
class PlayerCardRegistration(forms.Form):
